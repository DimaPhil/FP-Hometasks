...
/* package hw8-0.1.0.0 */
#define VERSION_hw8 "0.1.0.0"
#define MIN_VERSION_hw8(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hw8-0.1.0.0-JYzRyvYdyOz8QS5p7KNV9n"

#define CURRENT_PACKAGE_KEY "hw8-0.1.0.0-JYzRyvYdyOz8QS5p7KNV9n"
