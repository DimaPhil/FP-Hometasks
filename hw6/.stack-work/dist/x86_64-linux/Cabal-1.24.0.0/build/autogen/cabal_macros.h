...
/* package hw6-0.1.0.0 */
#define VERSION_hw6 "0.1.0.0"
#define MIN_VERSION_hw6(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hw6-0.1.0.0-3LNkNAhD9rXI9R806tlhLb"

#define CURRENT_PACKAGE_KEY "hw6-0.1.0.0-3LNkNAhD9rXI9R806tlhLb"
